...
class NivelBasico extends StatefulWidget {
  ...
  const NivelBasico({Key? key, required this.material, this.nivelUsuario = 4}) : super(key: key);
...
class _NivelBasicoState extends State<NivelBasico> {
  bool menuOpen = false;
  Map<String, dynamic>? basicoSeleccionado;
  YoutubePlayerController? _youtubeController;

  void toggleMenu() {
    setState(() {
      menuOpen = !menuOpen;
      basicoSeleccionado = null;
      ...
      child: Column(
        children: [
          ElevatedButton(
            ...
            child: Text(menuOpen ? 'Cerrar clases' : 'Nivel Básico'),
          ),
          if (menuOpen)
            Wrap(
              spacing: 8,
